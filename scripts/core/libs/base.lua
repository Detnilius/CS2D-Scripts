local _VERSION = 'lib.base: 1.0'

local error, getmetatable, ipairs, msg2, parse, print, setmetatable, tonumber, tostring, type
	= error, getmetatable, ipairs, msg2, parse, print, setmetatable, tonumber, tostring, type
